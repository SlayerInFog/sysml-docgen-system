...
set "WORKSPACE=E:\sysml\sysml-docgen-system"
set "JUPYTER_ROOT=E:\sysml\jupyter-work"
...
echo http://127.0.0.1:8888/lab/tree/sysml_docgen_openmbee_demo.ipynb
echo.
echo Startup log: %JUPYTER_ROOT%\jupyter-window.log
echo.

"E:\sysml\jupyter-env\Scripts\jupyter-lab.exe" notebooks --ip=127.0.0.1 --port=8888 --no-browser --ServerApp.use_redirect_file=False --ServerApp.token= --ServerApp.password= > "%JUPYTER_ROOT%\jupyter-window.log" 2>&1
